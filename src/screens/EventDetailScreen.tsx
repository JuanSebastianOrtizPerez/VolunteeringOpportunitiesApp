    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-3xl mx-auto px-6 py-8">
        ...
        <div className="bg-white rounded-2xl border border-gray-100 overflow-hidden mb-6">
          <img
            src={event.image || 'https://images.pexels.com/photos/5905445/pexels-photo-5905445.jpeg?auto=compress&cs=tinysrgb&w=800'}
            alt={event.title}
            className="w-full h-56 object-cover"
          />
          <div className="p-6">
            <span className={`inline-flex items-center gap-1 text-xs font-medium px-2.5 py-1 rounded-full ${CATEGORY_COLORS[cat]}`}>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mb-5">
              {[
                ...
                { icon: <Clock size={14} />, label: 'Commitment', value: event.commitment },
                { icon: <Users size={14} />, label: 'Spots', value: `${event.spots} open` },
              ].map(item => (
          ...
          <form onSubmit={handleApply} className="space-y-4">
            ...
            <div>
              ...
              <textarea
                ...
                required
                rows={4}
                placeholder="Tell us what motivates you to give your time…"
            ...
            <button
              type="submit"
              disabled={submitting}
              className="w-full bg-green-600 text-white py-3 rounded-xl font-semibold text-sm hover:bg-green-700 transition disabled:opacity-60 flex items-center justify-center gap-2"
            >
              <Send size={15} />
