        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {filtered.map(event => {
              ...
              return (
                <div key={event.id} onClick={() => { onSelectEvent(event); onNavigate('event-detail') }} className="bg-white/90 backdrop-blur-sm rounded-2xl overflow-hidden border border-gray-100 cursor-pointer hover:shadow-md hover:-translate-y-0.5 transition-all group">
