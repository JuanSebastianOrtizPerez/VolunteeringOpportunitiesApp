      ...
      <section className="pb-24 px-6 bg-gray-50">
        <div className="max-w-5xl mx-auto pt-16">
          <div className="flex items-center justify-between mb-8">
            ...
            <button onClick={() => onNavigate('login')} className="text-sm text-green-600 hover:text-green-700 font-medium flex items-center gap-1">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {[
              ...
              <div key={item.title} onClick={() => onNavigate('login')} className="bg-white rounded-2xl overflow-hidden border border-gray-100 cursor-pointer hover:shadow-md hover:-translate-y-0.5 transition-all">
          ...
          <div className="text-center mt-10">
            <button onClick={() => onNavigate('signup-volunteer')} className="inline-flex items-center gap-2 bg-green-600 text-white px-8 py-3.5 rounded-full font-semibold hover:bg-green-700 transition-all">
